'''
This 3D U-Net network implementation is available at: 
https://github.com/ellisdg/3DUnetCNN/blob/master/unet3d/model/isensee2017.py
'''
...
def get_unet(input_shape=(1, 80, 80, 80), n_base_filters=16, depth=5, dropout_rate=0.3,
